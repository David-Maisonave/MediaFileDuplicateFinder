...
namespace VDF.GUI.ViewModels {
	public sealed class ExpressionBuilderVM : ReactiveObject {
		...
		public ReactiveCommand<Unit, Unit> CancelCommand => ReactiveCommand.Create(() => host.Close(false));
		public ReactiveCommand<Unit, Unit> OKCommand => ReactiveCommand.Create(() => host.Close(true));
	}
}
