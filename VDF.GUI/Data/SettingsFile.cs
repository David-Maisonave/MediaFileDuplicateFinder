...
namespace VDF.GUI.Data {
	public class SettingsFile : ReactiveObject {
		...
		public enum SaveResultsOnExitOptions {
			Never_Save,
			Always_Save,
			Prompt_to_Save
		}
		SaveResultsOnExitOptions _SaveResultsOnExitOption = SaveResultsOnExitOptions.Always_Save;
		[JsonPropertyName("SaveResultsOnExitOption")]
		public SaveResultsOnExitOptions SaveResultsOnExitOption {
			get => _SaveResultsOnExitOption;
			set => this.RaiseAndSetIfChanged(ref _SaveResultsOnExitOption, value);
		}
		...
		int _AppWindowHeight = 0;
		[JsonPropertyName("AppWindowHeight")]
		public int AppWindowHeight {
			get => _AppWindowHeight;
			set => this.RaiseAndSetIfChanged(ref _AppWindowHeight, value);
		}
		int _AppWindowWidth = 0;
		[JsonPropertyName("AppWindowWidth")]
		public int AppWindowWidth {
			get => _AppWindowWidth;
			set => this.RaiseAndSetIfChanged(ref _AppWindowWidth, value);
		}
		int _AppPositionX = -1;
		[JsonPropertyName("AppPositionX")]
		public int AppPositionX {
			get => _AppPositionX;
			set => this.RaiseAndSetIfChanged(ref _AppPositionX, value);
		}
		int _AppPositionY = -1;
		[JsonPropertyName("AppPositionY")]
		public int AppPositionY {
			get => _AppPositionY;
			set => this.RaiseAndSetIfChanged(ref _AppPositionY, value);
		}
